...
(function () {
  ...
  var ICONS = {
    ...
    '⇄': '<path ' + S + ' d="M4 8h16M16 5l4 3-4 3M20 16H4M8 13l-4 3 4 3"/>',
    '✨': '<path ' + S + ' d="M12 3l1.8 5.2L19 10l-5.2 1.8L12 17l-1.8-5.2L5 10l5.2-1.8zM19 16l.8 2.2L22 19l-2.2.8L19 22l-.8-2.2L16 19l2.2-.8zM5 15l.6 1.6L7 17l-1.4.5L5 19l-.6-1.5L3 17l1.4-.4z"/>',
    '🪟': '<rect x="4" y="3" width="16" height="18" rx="1.5" ' + S + '/><path ' + S + ' d="M12 3v18M4 12h16"/>',
    ...
    '📲': '<rect ' + S + ' x="7" y="2.5" width="10" height="19" rx="2"/><path ' + S + ' d="M10.5 18.5h3"/><path ' + S + ' d="M3 9l2.5 2.5L3 14"/>',
