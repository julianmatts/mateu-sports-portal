...
(function(){
  ...
  // ---- cortina ----
  var CSS = ''
  +'.mbl{position:fixed;inset:0;z-index:2147483000;background:var(--marca-navy,#0B1527);display:flex;align-items:center;justify-content:center;padding:24px;'
  +'font-family:Barlow,system-ui,Segoe UI,sans-serif;color:var(--marca-navy,#0B1527);padding-top:calc(24px + env(safe-area-inset-top,0px))}'
  ...
  +'border-top:4px solid var(--marca-red,#CC0000);animation:mblIn .25s ease-out}'
  +'@keyframes mblIn{from{opacity:0;transform:translateY(8px)}to{opacity:1;transform:none}}'
  +'.mbl-ico{width:52px;height:52px;margin:0 auto 10px;border-radius:50%;background:var(--marca-off,#f5f7fc);display:flex;align-items:center;justify-content:center}'
  +'.mbl-ico svg{width:26px;height:26px;stroke:var(--marca-navy,#0B1527);fill:none;stroke-width:2;stroke-linecap:round;stroke-linejoin:round}'
  +'.mbl-marca{font-family:"Bebas Neue",Impact,sans-serif;font-size:26px;letter-spacing:2px;color:var(--marca-navy,#0B1527);line-height:1}'
  +'.mbl-tit{font-family:"Barlow Condensed",Barlow,sans-serif;font-weight:700;font-size:14px;letter-spacing:1.5px;text-transform:uppercase;color:var(--marca-red,#CC0000);margin-top:10px}'
  +'.mbl-sub{font-size:14px;color:#5a6478;margin-top:6px;line-height:1.4}'
  +'.mbl-sub b{color:var(--marca-navy,#0B1527);font-weight:600}'
  +'.mbl-pin{margin-top:18px;width:100%;box-sizing:border-box;padding:12px 14px;border:1.5px solid #cfd6e4;border-radius:10px;'
  +'font-family:Barlow,system-ui,sans-serif;font-size:26px;letter-spacing:12px;text-align:center;color:var(--marca-navy,#0B1527);outline:none;transition:border-color .15s}'
  +'.mbl-pin:focus{border-color:var(--marca-navy,#0B1527)}'
  +'.mbl-btn{margin-top:12px;width:100%;padding:13px;border:0;border-radius:10px;background:var(--marca-red,#CC0000);color:#fff;cursor:pointer;'
  ...
  +'.mbl-err{display:none;margin-top:10px;font-size:13px;color:var(--marca-red,#CC0000);font-weight:600}.mbl-err.on{display:block}'
  ...
  +'.mbl-salir:hover{color:var(--marca-navy,#0B1527)}'
