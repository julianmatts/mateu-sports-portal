...
(function(){
  ...
  var TUT = {
    ...
    barrida: { icono:'🧹', nombre:'Análisis de Reserva Depósito Central', pasos:[
      { ic:'🧹', t:'Qué es', d:'Dos pestañas: la «Barrida de reserva» (el cruce semanal de la reserva del Depósito Central contra las ventas por sucursal, para decidir la reposición) y el «Reparto inicial» (lo que entró, remito por remito).' },
