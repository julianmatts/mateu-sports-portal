...
(function(){
  ...
  var TUT = {
    ...
    barrida: { icono:'🧹', nombre:'Reparto de Mercadería', pasos:[
      ...
      { ic:'✨', t:'No repartir lo nuevo', d:'Si el reporte de reserva trae los «Días u.compra» de cada talle, tildá «No repartir lo que ingresó hace menos de N días» y elegí los días: esos talles no bajan en la barrida (van por el Reparto inicial). Se ven en ámbar con «Ver los talles que no hay».' },
