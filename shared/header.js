...
(function(){
  ...
  var CSS = ''
  +'.msh-top{background:var(--marca-navy,#0B1527);border-bottom:3px solid var(--marca-red,#CC0000);position:sticky;top:0;z-index:100}'
  ...
  +'.msh-menu{grid-column:1;justify-self:start;display:inline-flex;align-items:center;gap:9px;background:var(--marca-red,#CC0000);color:#fff;border:none;'
  ...
  +'.msh-subbar .msh-sub-t{font-family:\'Barlow Condensed\',sans-serif;font-weight:600;font-size:15px;letter-spacing:.6px;text-transform:uppercase;color:var(--marca-navy,#0B1527)}'
  /* drawer */
  ...
  +'.msh-dhead{background:var(--marca-navy,#0B1527);color:#fff;padding:12px;display:flex;align-items:center;justify-content:space-between;gap:10px;border-bottom:3px solid var(--marca-red,#CC0000)}'
  +'.msh-duser{display:flex;align-items:center;gap:12px;min-width:0}'
  +'.msh-dav{width:40px;height:40px;border-radius:50%;background:var(--marca-red,#CC0000);color:#fff;display:flex;align-items:center;'
  ...
  +'.msh-ditem{display:flex;align-items:center;gap:13px;padding:11px 12px;border-radius:12px;text-decoration:none;color:var(--marca-navy,#0B1527);transition:background .14s}'
  ...
  +'.msh-ditem.cur .msh-ic{background:var(--marca-red,#CC0000)}'
  +'.msh-ditem.cur .msh-nm{color:var(--marca-red,#CC0000)}'
  ...
  +'color:var(--marca-navy,#0B1527);font-family:\'Barlow Condensed\',sans-serif;font-weight:600;font-size:14px;letter-spacing:.3px}'
