...
(function(){
  ...
  var css=''
    ...
    +'#notifWidget .notif-fab:hover{transform:translateY(-2px);background:var(--marca-mid,#1a2f55)}'
    ...
    +'#notifWidget .notif-item:hover{background:var(--marca-off,#f5f7fc)}'
    ...
    +'#notifWidget .notif-item .kind.tablero{background:#eef1f8;color:var(--marca-mid,#1a2f55)}'
    ...
    +'#notifWidget .notif-aviso textarea:focus{outline:none;border-color:var(--marca-mid,#1a2f55)}'
