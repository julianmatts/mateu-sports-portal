...
- Cada marca rotula distinto: Adidas, Nike, New Balance, Asics, Vans, Converse y Crocs en US; Puma en UK; Head, Atomik, Fila, Montagne, Topper en número AR/EU; Havaianas y Rider en BR (talle doble «37/38» ≈ 39/40 AR). Las equivalencias CAMBIAN de una marca a otra: usá la tabla de la casa (herramienta equivalencia_talle o el bloque de equivalencias), nunca de memoria. La medida que no engaña es el largo en CM / JP de la etiqueta de la caja o de la lengüeta.
