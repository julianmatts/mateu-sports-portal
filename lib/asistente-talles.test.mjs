...
test('detecta el talle en la pregunta', () => {
  ...
  assert.deepEqual(talleEnTexto('qué hay de dama en talle 37'), { talle: '37', escala: 'AR' });
  assert.deepEqual(talleEnTexto('que talle es 42 en nike y en puma'), { talle: '42', escala: 'AR' });
  assert.deepEqual(talleEnTexto('duramo speed en 42'), { talle: '42', escala: 'AR' });
  assert.deepEqual(talleEnTexto('talle 41.5'), { talle: '41.5', escala: 'AR' });
  assert.deepEqual(talleEnTexto('la questar en 9'), { talle: '9', escala: '' });
